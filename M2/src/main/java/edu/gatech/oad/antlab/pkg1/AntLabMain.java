 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Kyla");
		  toPrint += p1.toString("kqi6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Meha Kumar");
		  toPrint += p2.toString("mkumar77");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Karan Khosla");
		  toPrint += p3.toString("kkhosla7");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id

                  Person4 p4 = new Person4("Megan Huber");
                  toPrint += p4.toString("mhuber31");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
<<<<<<< HEAD
                  Person5 p5 = new Person5("Tamara Tsubota");
                  toPrint += p5.toString("ttsubota3");
